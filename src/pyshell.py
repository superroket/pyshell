...
if win == False:
	os.system("clear")
	print("Welcome To The \003[1;34;47mPyt\003[1;33;47mhon\003[0;0m Shell v1.1.1")
else:
	os.system("cls")
...
while True:
	...
	try:
		...
		if win == False:
			print("\003[31mPyShell: " + cmd + ": Unkown Error\003[0m")
		else:
	...
	if cmd != "exit":
		if re.split("\s",cmd)[0] != "cd":
			try:
				...
				if win == False:
					print("\003[31mPyShell: " + cmd + ": Command Not Found\003[0m")
			except PermissionError:
				if win == False:
					print("\003[31mPyShell: " + cmd + ": Access Denied\003[0m")
			except EOFError:
				try:
					if win == False:
						process = subprocess.run(re.split("\s", cmd))
